...
<body class=" fixed-nav sticky-footer" id="page-top"
	...
	<nav class="navbar navbar-expand-lg  sticky-top" style="background-color: #000000; font-color: #08c2ff;">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<div class="navbar-nav mr-auto ml-auto text-center">
				...
				<a class="nav-item nav-link" href="#Map" type="button" 
				onclick="document.getElementById('mappa').style.display='block'"> Mappa Contagi</a> 
				...
				<div
					...
					<div class="modal-content">
											...
											<div class="dataTables_length" id="tipoUtente">
												<label> Selezione tipo di Utente <select
													...
													style="font-family: verdana; font-weight: 900;">
														...
														<option value="Operatore">Operatore Comunale</option>
						...
						<div class="modal-footer">
							<button class="btn btn-danger" data-dismiss='modal'>Anulla</button>
						</div>
					</div>
				</div>
			</div>
	...
	<form action="VisualizzaMsg" id="msj" method="post">
		<div class="container">
...
<form action="EliminaMsg" id="eliminamsj" method="post">
		...
		$("#messaggi").click(function(){
			 document.forms[0].action = "VisualizzaMsg";
...
$("#messaggi").click(function(){
	console.log("sdahjdjhhjasdjh");
//$("#containerMessaggi").html("mekjhfadgaisjòdhgasldòifasghlhfdòaj");
	...
	<div class="mappa" id="mappa" style="margin-top:20px; display:none">
		...
		<map id="Map" name="Map">
			...
			<area shape="poly"
				...
				href="#" alt="Val d'Aosta" title="Val d'Aosta"
			...
			<area shape="poly"
				...
				href="#" alt="Piemonte" title="Piemonte"
			...
			<area shape="poly"
				...
				href="#" alt="Lombardia" title="Lombardia"
			...
			<area shape="poly"
				...
				href="#" alt="Trentino" title="Trentino"
			...
			<area shape="poly"
				...
				href="#" alt="Liguria" title="Liguria"
			...
			<area shape="poly"
				...
				href="#" alt="Toscana" title="Toscana"
			...
			<area shape="poly"
				...
				href="#" alt="Abruzzo" title="Abruzzo"
			...
			<area shape="poly"
				...
				href="#" alt="Campania" title="Campania"
			...
			<area shape="poly"
				...
				href="#" alt="Basilicata" title="Basilicata"
			...
			<area shape="poly"
				...
				href="#" alt="Calabria" title="Calabria"
			...
			<area shape="poly"
				...
				href="#" alt="Sicilia" title="Sicilia"
			...
			<area shape="poly"
				...
				href="#" alt="Sardegna" title="Sardegna"
