...
<body class=" fixed-nav sticky-footer" id="page-top"
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<div class="navbar-nav mr-auto ml-auto text-center">
				...
				<a id="messaggi" class="nav-item nav-link" href="#messaggi" data-toggle='modal'
					...
					<a class="nav-item nav-link" href="#tamponi" data-toggle='modal'
					data-target="#modaltamponi"> Richiedi tamponi </a>
					 
					 <a class="nav-item nav-link" href="#registro" data-toggle='modal'
					data-target="#modalRegistro"> Registra Utenti</a>
	...
	<!-- Registro utenti -->
	<form class="user" action="RegistraUtente" method="post" id="registro">
		<div class="container ">

			<div class="modal fade" tabindex="-1" id="modalRegistro">
				<div
					class="modal-dialog modal-lg modal-dialog-centered modal-xl modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-header"
							style="text: center; font-family: verdana; opacity: 0.8; font-weight: 900; background-color: #1a1aff; color: white;">Registra
							utenti</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-12 mb-3 sm-0">
											<div class="dataTables_length" id="dataTable_length">
												<label> <select name="genere"
													aria-controls="dataTable"
													class="custom-select custom-select-sm form-control form-control-sm"
													style="font-family: verdana; font-weight: 900;"><option
															value="M">Maschio</option>
														<option value="F">Femmina</option></select></label>
											</div>
										</div>

										<div class="col-sm-12 mb-3 sm-0">
											<div class="dataTables_length" id="dataTable_length">
												<label>Zona di Residenza:<select
													name="zonaResidenza" aria-controls="dataTable"
													class="custom-select custom-select-sm form-control form-control-sm"
													style="font-family: verdana; font-weight: 900;">
										...
										<div class="col-sm-12 mb-3 sm-0">
											<div class="dataTables_length" id="dataTable_length">
												<label>Zona di Lavoro:<select name="zonaLavoro"
													aria-controls="dataTable"
													class="custom-select custom-select-sm form-control form-control-sm"
													style="font-family: verdana; font-weight: 900;">
														<option value="1">Abruzzo</option>
										...
										<div class="col-sm-12 mb-3 sm-2">
											<div class="dataTables_length" id="tipoUtente">
												<label> Selezione tipo di Utente <select
													name="tipoUtente" aria-controls="dataTable"
													class="custom-select custom-select-sm form-control form-control-sm"
													style="font-family: verdana; font-weight: 900;">

														<option value="Agente">Agente Polizia</option>
	...
	<!-- </div> -->
	<!-- Servlet MsgMedico -->
	<form action="MsgMedico" method="post" id="tamponi">
		<div class="container">
			<div class="modal fade" tabindex="-1" id="modaltamponi">
	...
	<div class="mappa" id="mappa" style="margin-top:20px">
		...
		<map id="Map" name="Map">
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=valdaosta" alt="Val d'Aosta" title="Val d'Aosta"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=piemonte" alt="Piemonte" title="Piemonte"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=lombardia" alt="Lombardia" title="Lombardia"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=trentino" alt="Trentino" title="Trentino"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=veneto" alt="Veneto" title="Veneto"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=friuli" alt="Friuli" title="Friuli"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=liguria" alt="Liguria" title="Liguria"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=emilia" alt="Emilia" title="Emilia"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=toscana" alt="Toscana" title="Toscana"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=marche" alt="Marche" title="Marche"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=umbria" alt="Umbria" title="Umbria"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=lazio" alt="Lazio" title="Lazio"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=abruzzo" alt="Abruzzo" title="Abruzzo"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=molise" alt="Molise" title="Molise"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=campania" alt="Campania" title="Campania"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=puglia" alt="Puglia" title="Puglia"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=basilicata" alt="Basilicata" title="Basilicata"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=calabria" alt="Calabria" title="Calabria"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=sicilia" alt="Sicilia" title="Sicilia"
			...
			<area shape="poly"
				...
				href="Comune.jsp?status=sardegna" alt="Sardegna" title="Sardegna"
