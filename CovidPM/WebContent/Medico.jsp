...
<body class=" fixed-nav sticky-footer" id="page-top"
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<div class="navbar-nav mr-auto ml-auto text-center">
				...
				<a class="nav-item nav-link" href="#tamponi" data-toggle='modal'
					data-target="#modaltamponi"> Esegui Test </a>
	...
	<!-- Servlet test -->
	<form action="EseguiTest" method="post" id="tamponi">
		<div class="container">
			<div class="modal fade" tabindex="-1" id="modaltamponi">
				...
				<div class="modal-dialog modal-dialog-centered modal-xl">
					<div class="modal-content">
						<div class="modal-header"
							style="text: center; font-family: verdana; opacity: 0.8; font-weight: 900; background-color: #1a1aff; color: white;">
							Esegui Test</div>
						<div class="modal-body">
		...
		<%
			...
			if (accesso != null && accesso.equals("testato")) {
		%>
		<script>
			swal("Test eseguito!", "Clicca ok per continuare",
					"success")
		</script>
		<%
			}
	...
	<div class="mappa" id="mappa" style="margin-top:20px">
		...
		<map id="Map" name="Map">
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=valdaosta" alt="Val d'Aosta" title="Val d'Aosta"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=piemonte" alt="Piemonte" title="Piemonte"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=lombardia" alt="Lombardia" title="Lombardia"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=trentino" alt="Trentino" title="Trentino"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=veneto" alt="Veneto" title="Veneto"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=friuli" alt="Friuli" title="Friuli"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=liguria" alt="Liguria" title="Liguria"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=emilia" alt="Emilia" title="Emilia"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=toscana" alt="Toscana" title="Toscana"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=marche" alt="Marche" title="Marche"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=umbria" alt="Umbria" title="Umbria"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=lazio" alt="Lazio" title="Lazio"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=abruzzo" alt="Abruzzo" title="Abruzzo"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=molise" alt="Molise" title="Molise"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=campania" alt="Campania" title="Campania"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=puglia" alt="Puglia" title="Puglia"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=basilicata" alt="Basilicata" title="Basilicata"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=calabria" alt="Calabria" title="Calabria"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=sicilia" alt="Sicilia" title="Sicilia"
			...
			<area shape="poly"
				...
				href="Medico.jsp?status=sardegna" alt="Sardegna" title="Sardegna"
...
<% 
accesso = request.getParameter("status");
